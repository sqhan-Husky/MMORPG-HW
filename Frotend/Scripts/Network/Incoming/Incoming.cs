...
namespace Gamekit3D.Network
{
    public partial class Incoming
    {
        ...
        public void RegisterAll()
        {
			...
			register.Register(Command.S_ITEM_APPLY, OnRecvApplySuccess);
			register.Register(Command.S_GET_FRIENDS, OnRecvGetFriends);
            register.Register(Command.S_RECV_MESSAGE, OnRecvRecvMessage);
            register.Register(Command.S_SEND_MESSAGE, OnRecvSendMessage);
			register.Register(Command.S_BUY_ITEMS, OnRecvItemBuy);
			register.Register(Command.S_LEVEL_UP, OnRecvLevelUp);
			register.Register(Command.S_GIVE_GIFT, OnRecvGiveGift);
            register.Register(Command.S_TRADE_BUY, OnRecvTradeBuy);
